...
const Web3ReactConnectionComponent = () => {
    ...
    async function fetchData() {
        ...
        //     await web3reactContext.activate(injected)
        //     console.log("web3reactContext",web3reactContext)
        //     console.log("web3reactContext.library",web3reactContext.library)
        //     const contract = getContract(web3reactContext.library, web3reactContext.account);
        //     try {
    ...
    async function mintMethod(id) {
        ...
        if (web3reactContext.connector === undefined) {
            ...
            console.log("second error", web3reactContext)
            setMessage("")
            return
        }
        ...
        if(typeof window.ethereum !== 'undefined') {
            ...
            try {
                ...
                if (mintType=='mint'){
                    ...
                    const transaction = await myContractSigner.regularMint(mintNumber, {value: ethers.utils.parseEther(total_price)});
